...
@InfoIntegracaoRestClickupListas(tipo = FabIntRestClickupListas.LISTA_CRIAR_NO_ESPACO)
public class IntegracaoRestClickupListaCriarNoEspaco
		extends
			AcaoApiIntegracaoComOauthAbstrato {

	public IntegracaoRestClickupListaCriarNoEspaco(
			final FabTipoAgenteClienteApi pTipoAgente,
			final ItfUsuario pUsuario, final java.lang.Object... pParametro) {
		super(FabIntRestClickupListas.LISTA_CRIAR_NO_ESPACO, pTipoAgente,
				pUsuario, pParametro);
	}
}